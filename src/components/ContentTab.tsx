      ...
      <TabsContent value="copyqa" className="mt-4">
        <Card>
          <CardHeader>
            ...
            <p className="text-sm text-muted-foreground">
              {tx({ he: "הדבק את הטקסט השיווקי שלך. נבדוק אותו מול 6 מדדי שכנוע + 8 כללי עברית", en: "Paste your marketing copy. We'll audit it against 6 persuasion metrics + 8 Hebrew rules" }, language)}
            </p>
          </CardHeader>
