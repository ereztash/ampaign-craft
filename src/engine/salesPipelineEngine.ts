...
export function getNeuroClosingFrameworks(
  ...
  const frameworks: NeuroClosingFramework[] = [
    {
      ...
      vector: "dopamine", vectorLabel: { he: "עקביות", en: "Consistency" },
    ...
    {
      name: { he: "סגירת כניסה (מדרגות)", en: "Stepped Entry Close" },
      vector: "cortisol", vectorLabel: { he: "כניסה נמוכה · רכישה", en: "Low Entry · Purchase" },
      psychology: { he: "מחסום כניסה נמוך יוצר מחויבות ראשונה. ההקלה אחרי הרכישה מחזקת נאמנות", en: "Low entry barrier creates first commitment. Relief after purchase builds loyalty." },
    ...
    },
    {
      ...
      vector: "oxytocin", vectorLabel: { he: "אמון", en: "Trust" },
      psychology: { he: "מצב של 'אנחנו ביחד'. תחושת שותפות אמיתית מפחיתה התנגדות ומגבירה מחויבות", en: "A 'we're in this together' state. Genuine partnership reduces resistance and increases commitment." },
    ...
    },
    {
      ...
      vector: "dopamine", vectorLabel: { he: "ביטחון", en: "Certainty" },
      psychology: { he: "חשיבה אנליטית: הצגת נתונים ברורים מגבירה ביטחון בהחלטה", en: "Analytical thinking: presenting clear data builds confidence in the decision." },
    ...
    },
    {
      ...
      vector: "oxytocin", vectorLabel: { he: "זהות חברתית", en: "Social Identity" },
      psychology: { he: "אנשים רוצים להיות חלק מקבוצה. תחושת השייכות מחזקת את ההחלטה לרכוש", en: "People want to belong. Sense of membership strengthens the purchase decision." },
  ...
  if (salesType === "enterprise") {
    frameworks.push({
      ...
      vector: "oxytocin", vectorLabel: { he: "מנטורינג", en: "Mentorship" },
