...
const PHASE_1_QUESTIONS: PhaseQuestion[] = [
  ...
  { id: "currentPositioning", type: "textarea", required: false,
    label: { he: "מה הבידול שלך היום? (לא חובה)", en: "What is your current differentiation? (optional)" },
    placeholder: { he: "אם קשה לנסח - אפשר לדלג. נחלץ את זה יחד בהמשך", en: "If it's hard to phrase - you can skip. We'll extract it together later" },
    helperText: { he: "אם כותבים, כתבו מה שאתם אומרים ללקוחות, לא מה שהייתם רוצים. ואם אתם לא יודעים להגיד - זה בסדר גמור, בשביל זה אנחנו כאן", en: "If you write, write what you tell customers, not what you wish it was. And if you can't say it - that's completely fine, that's what we're here for" } },
